...
import rapid_evolution.ui.AlbumCoverUI;
...
public class MediaSliderUI extends BasicSliderUI {
    ...
    private static Logger log = Logger.getLogger(MediaSliderUI.class);
...
//    @Override
    protected void calculateTrackRect() {
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            trackRect.height = contentRect.height - trackRect.y - right.getHeight() - trackBuffer;
        }
    }
