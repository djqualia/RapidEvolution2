package com.mixshare.rapid_evolution.music.spiral;
...
public class SpiralKey {
    ...
    public SpiralKey(boolean major, String type, Vector points) {
        this.major = major;
        this.type = type;
        this.points = points;
    }
    ...
    public synchronized void getKeyProbabilities(Point centerEffectPoint, double[] result) {
        for (int i = 0; i < 12; ++i) {
