...
public class JID3TagWriter extends BaseTagWriter {
    ...
    public void setUser1(String value) {
        if (id3v230_tag != null) {
            try {
                id3v230_tag.removeTXXXTextInformationFrame(TagUtil.getUser1TagId());
                if (!value.equals("")) id3v230_tag.addTXXXTextInformationFrame(new TXXXTextInformationID3V2Frame(TagUtil.getUser1TagId(), value));
            } catch (ID3Exception e) {
    ...
    public void setUser2(String value) {
        if (id3v230_tag != null) {
            try {
                id3v230_tag.removeTXXXTextInformationFrame(TagUtil.getUser2TagId());
                if (!value.equals("")) id3v230_tag.addTXXXTextInformationFrame(new TXXXTextInformationID3V2Frame(TagUtil.getUser2TagId(), value));
            } catch (ID3Exception e) {
                log.debug("setUser2(): error ID3Exception", e);
            }
        }
    }
    ...
    public void setUser3(String value) {
        if (id3v230_tag != null) {
            try {
                id3v230_tag.removeTXXXTextInformationFrame(TagUtil.getUser3TagId());
                if (!value.equals("")) id3v230_tag.addTXXXTextInformationFrame(new TXXXTextInformationID3V2Frame(TagUtil.getUser3TagId(), value));
            } catch (ID3Exception e) {
                log.debug("setUser3(): error ID3Exception", e);
            }
        }
    }
    ...
    public void setUser4(String value) {
        if (id3v230_tag != null) {
            try {
                id3v230_tag.removeTXXXTextInformationFrame(TagUtil.getUser4TagId());
                if (!value.equals("")) id3v230_tag.addTXXXTextInformationFrame(new TXXXTextInformationID3V2Frame(TagUtil.getUser4TagId(), value));
            } catch (ID3Exception e) {
                log.debug("setUser4(): error ID3Exception", e);
            }
        }
    }    
