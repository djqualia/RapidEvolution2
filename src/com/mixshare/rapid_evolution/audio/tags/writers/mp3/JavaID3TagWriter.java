...
public class JavaID3TagWriter extends BaseTagWriter {
    ...
    public void setUser1(String value) {
        if (id3v2 != null) {
            FrameBodyTXXX frameBody = getTXXXFrame(TagUtil.getUser1TagId());
            if (frameBody != null) {
                frameBody.setText(value);
            } else {
                frameBody = new FrameBodyTXXX((byte) 0, TagUtil.getUser1TagId(), value);
                id3v2.setFrame(getNewFrame(frameBody));
            }            
        }        
    }
    ...
    public void setUser2(String value) {
        if (id3v2 != null) {
            FrameBodyTXXX frameBody = getTXXXFrame(TagUtil.getUser2TagId());
            if (frameBody != null) {
                frameBody.setText(value);
            } else {
                frameBody = new FrameBodyTXXX((byte) 0, TagUtil.getUser2TagId(), value);
                id3v2.setFrame(getNewFrame(frameBody));
            }            
        }        
    }
    ...
    public void setUser3(String value) {
        if (id3v2 != null) {
            FrameBodyTXXX frameBody = getTXXXFrame(TagUtil.getUser3TagId());
            if (frameBody != null) {
                frameBody.setText(value);
            } else {
                frameBody = new FrameBodyTXXX((byte) 0, TagUtil.getUser3TagId(), value);
                id3v2.setFrame(getNewFrame(frameBody));
            }            
        }        
    }
    ...
    public void setUser4(String value) {
        if (id3v2 != null) {
            FrameBodyTXXX frameBody = getTXXXFrame(TagUtil.getUser4TagId());
            if (frameBody != null) {
                frameBody.setText(value);
            } else {
                frameBody = new FrameBodyTXXX((byte) 0, TagUtil.getUser4TagId(), value);
                id3v2.setFrame(getNewFrame(frameBody));
            }            
        }        
    }
