...
public class JAudioTagReader extends BaseTagReader {
    ...
    public String getUser1() {
        ...
        FrameBodyTXXX txxx_frame = getTXXXFrame(TagUtil.getUser1TagId());
        if (txxx_frame != null) {
    ...
    public String getUser2() {
        String userfield = null;
        FrameBodyTXXX txxx_frame = getTXXXFrame(TagUtil.getUser2TagId());
        if (txxx_frame != null) {
            userfield = txxx_frame.getText();
        }
        return userfield;          
    ...
    public String getUser3() {
        String userfield = null;
        FrameBodyTXXX txxx_frame = getTXXXFrame(TagUtil.getUser3TagId());
        if (txxx_frame != null) {
            userfield = txxx_frame.getText();
        }
        return userfield;          
        ...
        if (id3v2 != null) {
            ...
            if (frame != null) {
                if (frame.getBody() instanceof FrameBodyTYER) {
                    ...
                    year = frameBody.getText();
                } else {
                    log.trace("getYear(): frame=" + frame + ", class=" + frame.getBody().getClass());
                }
            }
