...
//            FileSource source_file = new FileSource();
    ...
    public String getUser1() {
        return getTXXXValue(new String[] { TagUtil.getUser1TagId() });        
    }
    
    public String getUser2() {
        return getTXXXValue(new String[] { TagUtil.getUser2TagId() });        
    }

    public String getUser3() {
        return getTXXXValue(new String[] { TagUtil.getUser3TagId() });        
    }

    public String getUser4() {
        return getTXXXValue(new String[] { TagUtil.getUser4TagId() });        
    }
    ...
    private String getStyle(int style_number) {
        ...
        return getTXXXValue(identifier);
    }
