...
public class DetectBeatIntensityBatchProgressUI extends REDialog implements ActionListener {
    public DetectBeatIntensityBatchProgressUI(String id) {
      super(id);
        instance = this;
        setupDialog();
    ...
    public static DetectBeatIntensityBatchProgressUI instance = null;
