...
public class AddIncludeSongsKeyListener extends KeyAdapter {
  ...
  public void keyPressed(KeyEvent e) {
    if (e.getKeyCode() == e.VK_BACK_SPACE) {
      ...
      AddStyleSongsUI.instance.ProcessAddIncludeStyle();
    } else if (e.getKeyCode() == e.VK_ESCAPE) {
      AddStyleSongsUI.instance.CancelAddStyleSongs();
    }
    ...
    if (((c >= 'a') && (c <= 'z')) || ((c >= '0') && (c <= '9')) || (c == '.') || (c == ',') || (c == '-') || (c == '_') || (c == '+') || (c == '\'') || (c == ':') || (c == ';') || (c == '\\') || (c == '/') || (c == '[') || (c == ']') || (c == '{') || (c == '}') || (c == '`') || (c == '!') || (c == '@') || (c == '#') || (c == '$') || (c == '%') || (c == '^') || (c == '&') || (c == '*') || (c == '(') || (c == ')') || (c == '|') || (c == '~')) {
      ...
      DefaultListModel dlm = (DefaultListModel) AddStyleSongsUI.instance.addsongincludelist.getModel();
      int start = AddStyleSongsUI.instance.addsongincludelist.getSelectedIndex();
      int index = start;
      ...
      if (index != start) {
        AddStyleSongsUI.instance.addsongincludelist.setSelectedIndex(index);
        AddStyleSongsUI.instance.addsongincludelist.ensureIndexIsVisible(index);
