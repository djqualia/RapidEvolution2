 ...
 * @version 1.0
 */
public class StyleExcludeMouse extends MouseAdapter implements ActionListener {
...
//          Point absolute = new Point(relative.x + location.x, relative.y + location.y);
  ...
  static public StyleExcludeMouse instance = null;
  public StyleExcludeMouse() {
    instance = this;
  ...
  public void actionPerformed(ActionEvent ae) {
    ...
    if (ae.getSource() == edititem) {
      ...
      if (EditStyleUI.instance.styleexcludelist.getSelectedIndices().length == 1) {
        try {
          EditSongUI.instance.EditSong(SongDB.instance.NewGetSongPtr(((Long)EditStyleUI.instance.editedstyle.styleexcludevector.get(EditStyleUI.instance.styleexcludelist.getSelectedIndex())).longValue()));
        } catch (Exception e) { }
      }
      ...
      for (int i = 0; i < EditStyleUI.instance.styleexcludelist.getSelectedIndices().length; ++i) {
        try {
          SongLinkedList song = SongDB.instance.NewGetSongPtr(((Long)EditStyleUI.instance.editedstyle.styleexcludevector.get(EditStyleUI.instance.styleexcludelist.getSelectedIndices()[i])).longValue());
          songstoplay.add(song);
        } catch (Exception e) {
          String keyword = (String)EditStyleUI.instance.editedstyle.styleexcludevector.get(EditStyleUI.instance.styleexcludelist.getSelectedIndices()[i]);
          SongLinkedList iter = SongDB.instance.SongLL;
          while (iter != null) {
              if (!EditStyleUI.instance.editedstyle.containsDirect(iter)) {
                if (EditStyleUI.instance.editedstyle.matchesExcludeKeywords(iter, keyword)) {
